...
fn main() {
    ...
    let img = generate_mandelbrot_image(width, height, &params);
...
fn generate_mandelbrot_image(width: u32, height: u32, params: &FractalParams) -> ImageBuffer<Rgba<u8>, Vec<u8>> {
